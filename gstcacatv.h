...
struct _GstCACATv {
	...
	gint sink_width, sink_height; //input resolution
	gint canvas_height, canvas_width;  //terminal size (80x24 by default)
	gint src_width,  src_height;  //output resolution determined from canvas size & font size
	gint font_index;
...
struct _GstCACATvClass {
	GstVideoFilterClass parent_class;  //changed from sink to filter class 
